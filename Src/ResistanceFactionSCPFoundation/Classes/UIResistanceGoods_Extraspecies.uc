class UIResistanceGoods_Extraspecies extends UISimpleCommodityScreen;
...
//
	...
	//{
		//PlaySFX("BuildItem");
		//ExtraspeciesRecruits.BuyResistanceGood(arrItems[iSelectedItem].RewardRef);
		//GetItems();
		//PopulateData();
//
...
//
	...
	//arrItems = ExtraRecruits.ResistanceGoods;
//}
//
