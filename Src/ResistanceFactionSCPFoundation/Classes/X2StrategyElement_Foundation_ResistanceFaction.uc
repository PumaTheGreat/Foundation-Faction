...
//---------------------------------------------------------------------------------------
class X2StrategyElement_Foundation_ResistanceFaction extends X2StrategyElement
	config(GameBoard);
...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	local X2SCPResistanceFactionTemplate Template;
	local name FactionName;

	foreach default.Factions(FactionName)
	{
		`CREATE_X2TEMPLATE(class'X2SCPResistanceFactionTemplate', Template, FactionName);
